...
def on_b_pressed():
    global Score
    if controller.B.is_pressed() and Cherries.overlaps_with(mySprite):
        Cherries.destroy()
        info.change_life_by(2)
    if controller.B.is_pressed() and Apple.overlaps_with(mySprite):
        Apple.destroy()
...
def Level_1():
    global mySprite, Jester, Ghost_Amount, Score, Ghost_Speed, statusbar, Ghost, Level_1_Complete
    ...
    Jester = sprites.create(img("""
        ...
        SpriteKind.player)
    mySprite.x += -25
    Jester.set_stay_in_screen(True)
    Ghost.set_bounce_on_wall(True)
    Ghost_Amount = 1
    Score = 0
    Ghost_Speed = 5
    ...
    Ghost = sprites.create(img("""
        ...
        SpriteKind.enemy)
    Ghost_Amount = 1
    Ghost.set_position(randint(0, 160), randint(0, 120))
...
def on_a_pressed():
    global mySprite, Start, Tutorial, Info, Mouse
    animation.run_image_animation(mySprite,
        [img("""
                ........................
                        .....ffff...............
        ...
        100,
        False)
    if controller.A.is_pressed() and Mouse.overlaps_with(Start):
        Start2()
    if controller.A.is_pressed() and Mouse.overlaps_with(Tutorial):
        Tutorial2()
    if controller.A.is_pressed() and controller.left.is_pressed():
        animation.run_image_animation(mySprite,
            [img("""
                    ..............ffffff....
                                .............f2feeeeff..
            ...
            100,
            False)
    if controller.A.is_pressed() and controller.right.is_pressed():
        animation.run_image_animation(mySprite,
            [img("""
                    ........................
                                ....ffffff..............
            ...
            100,
            False)
    if Back_Arrow.overlaps_with(Mouse) and controller.A.is_pressed():
        sprites.destroy_all_sprites_of_kind(SpriteKind.level)
        scene.set_background_image(img("""
            
        ...
        Start = sprites.create(img("""
            ...
            """),
            SpriteKind.StartScreen)
        Start.change_scale(1, ScaleAnchor.MIDDLE)
        Start.x += 23
        Start.y += -10
        Tutorial = sprites.create(img("""
            ...
            """),
            SpriteKind.StartScreen)
        Tutorial.change_scale(0.1, ScaleAnchor.MIDDLE)
        Tutorial.y += 45
        Info = sprites.create(img("""
            ...
            """),
            SpriteKind.StartScreen)
        Info.change_scale(0.05, ScaleAnchor.MIDDLE)
        Info.y += 40
        Info.x += 10
        Mouse = sprites.create(img("""
            ...
            """),
            SpriteKind.StartScreen)
        Mouse.set_position(75, 45)
        Mouse.set_stay_in_screen(True)
        controller.move_sprite(Mouse)
    if Mouse.overlaps_with(_DotDotDot) and controller.A.is_pressed():
        game.show_long_text("Coming Soon...", DialogLayout.FULL)
    if Mouse.overlaps_with(Info) and controller.A.is_pressed():
        scene.set_background_image(img("""
            
                        ...
                        7777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777
        """))
        game.show_long_text("Cherry = 2 hearts                        Strawberry = 5 points                        Apple = 10 points     Taco = 20 points          Doughnut = 50 points",
            DialogLayout.FULL)
    Level_Caller()
controller.A.on_event(ControllerButtonEvent.PRESSED, on_a_pressed)

def Level_Caller():
    if Mouse.overlaps_with(_1) and controller.A.is_pressed():
        sprites.destroy_all_sprites_of_kind(SpriteKind.level)
        Level_1()
    if Mouse.overlaps_with(_2) and controller.A.is_pressed():
        sprites.destroy_all_sprites_of_kind(SpriteKind.level)
        Level_2()
    if Mouse.overlaps_with(_3) and controller.A.is_pressed():
        sprites.destroy_all_sprites_of_kind(SpriteKind.level)
        Level_3()
    if Mouse.overlaps_with(_4) and controller.A.is_pressed():
        sprites.destroy_all_sprites_of_kind(SpriteKind.level)
        Level_4()
    if Mouse.overlaps_with(_5) and controller.A.is_pressed():
        sprites.destroy_all_sprites_of_kind(SpriteKind.level)
        Level_5()
def Tutorial2():
    global Score, StartPressed, statusbar, mySprite, Jester, Ghost, Cherries, Apple
    sprites.destroy_all_sprites_of_kind(SpriteKind.StartScreen)
    Score = 0
    StartPressed = 0
    scene.set_background_image(img("""
        7777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777
    ...
    pause(100)
    Jester.say_text("Hi, my name is Jester. I will be your guide.", 5000, False)
    pause(5000)
    scene.set_background_image(img("""
        
                ...
                7777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777
    """))
    Jester.say_text("Your main enemy is the ghosts. You need to protect me. ",
        5000,
        False)
    pause(5000)
    Jester.say_text("Move to the ghost with the joystick.", 3000, False)
    pause(100)
    Ghost = sprites.create(img("""
            ........................
                    ........................
        ...
        """),
        SpriteKind.enemy)
    Ghost.set_position(75, 45)
    pause(7500)
    if Ghost.overlaps_with(mySprite):
        Jester.say_text("Press A to use sword.", 4000, False)
    pause(5000)
    if Score == 1:
        Jester.say_text("Good job!", 2000, False)
        pause(2000)
    Jester.say_text("You can consume fruit by pressing B to gain points or hearts.",
        10000,
        False)
    pause(10000)
    Cherries = sprites.create(img("""
        ...
        """),
        SpriteKind.food)
    Cherries.set_position(75, 100)
    Jester.say_text("Cherries give you 2 extra hearts.", 3000, False)
    pause(3000)
    Jester.say_text("Move to the cherries of consume them.", 5000, False)
    pause(10000)
    Apple = sprites.create(img("""
        ...
        """),
        SpriteKind.food)
    Apple.set_stay_in_screen(False)
    Apple.set_position(-50, 100)
    Apple.x += 170
    Jester.say_text("Apples give you 10 extra points.", 5000, False)
    pause(5000)
    Jester.say_text("Move to the apple and consume it.", 5000, False)
    pause(10000)
    Jester.say_text("Congratulations! You have completed the tutorial.",
        7000,
        False)
    pause(5000)
...
def Level_4():
    global mySprite, Jester, Ghost_Amount, Score, Ghost_Speed, statusbar, Ghost, Level_4_Complete
    mySprite.destroy()
    Ghost.destroy()
    Jester.destroy()
    statusbar.destroy()
...
def Start2():
    global StartPressed, _DotDotDot, Back_Arrow, Mouse
    sprites.destroy_all_sprites_of_kind(SpriteKind.StartScreen)
    Start.destroy()
    Ghost.destroy()
    Jester.destroy()
    ...
    levels_Completed()
    pause(100)
    _1.set_position(15, 15)
    _2.set_position(45, 15)
    _3.set_position(75, 15)
    _4.set_position(105, 15)
    _5.set_position(135, 15)
...
def Statusbar_death_tracker():
    if statusbar.value == 0:
        info.change_life_by(-1)
        statusbar.value += 100
        pause(100)
def Level_5():
    global mySprite, Jester, Ghost_Amount, Score, Ghost_Speed, statusbar, Ghost, Level_5_Complete
    mySprite.destroy()
    Ghost.destroy()
    Jester.destroy()
    statusbar.destroy()
    ...
    if True:
        ...
        Start2()
def Level_3():
    global mySprite, Jester, Ghost_Amount, Score, Ghost_Speed, statusbar, Ghost, Level_3_Complete
    mySprite.destroy()
    Ghost.destroy()
    Jester.destroy()
    statusbar.destroy()
    ...
    if True:
        ...
        pause(1000)
        Start2()
def Jester_move_from_edge():
    Jester.set_position(0, 100)
    for index5 in range(50):
        Jester.x += 1
        pause(15)
def Level_2():
    global mySprite, Jester, Ghost_Amount, Score, Ghost_Speed, statusbar, Ghost, Level_2_Complete
    mySprite.destroy()
    Ghost.destroy()
    Jester.destroy()
    statusbar.destroy()
...
Mouse: Sprite = None
Info: Sprite = None
Tutorial: Sprite = None
Start: Sprite = None
mySprite: Sprite = None
Jester: Sprite = None
Ghost: Sprite = None
Apple: Sprite = None
Cherries: Sprite = None
statusbar: StatusBarSprite = None
Back_Arrow: Sprite = None
_DotDotDot: Sprite = None
_5: Sprite = None
_4: Sprite = None
_3: Sprite = None
_2: Sprite = None
...
def on_forever():
    global Score, Ghost_Amount
    if controller.A.is_pressed() and controller.B.is_pressed():
        Start2()
    if Ghost.overlaps_with(mySprite) and controller.A.is_pressed():
        animation.run_image_animation(mySprite,
            [img("""
                    ........................
                                .....ffff...............
